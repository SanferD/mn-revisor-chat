...
export const SINCH_API_TOKEN_ENV_NAME = "SINCH_API_TOKEN";
export const SINCH_SERVICE_ID_ENV_NAME = "SINCH_SERVICE_ID";
export const SINCH_VIRTUAL_PHONE_NUMBER_ENV_NAME = "SINCH_VIRTUAL_PHONE_NUMBER";
